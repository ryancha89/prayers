...
export const translations = {
  ko: {
    ...
    'detail.needChartHint': '이 계정에는 아직 사주가 없어서 상담사가 풀이할 것이 없습니다.',
  ...
  en: {
    ...
    'detail.needChartHint': 'This account has no saju chart yet, so there is nothing for the counselor to read.',
  ...
  ja: {
    ...
    'detail.needChartHint': 'このアカウントにはまだ命式がなく、占う対象がありません。',
  ...
  'zh-CN': {
    ...
    'detail.needChartHint': '这个账号还没有命盘，咨询师没有可解读的东西。',
  ...
  'zh-TW': {
    ...
    'detail.needChart': '需要出生日期',
    'detail.needChartHint': '這個帳號還沒有命盤，諮詢師沒有可解讀的東西。',
  ...
  vi: {
    ...
    'detail.needChartHint': 'Tài khoản này chưa có lá số, nên thầy chưa có gì để luận.',
